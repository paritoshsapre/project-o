...
public:
	...
	void UpdateLook(CPlayer* pPlayer, ICharacterInstance* pCharacter, bool bEnabled, f32 FOV, const Vec3& LookAtTarget, const uint32 lookIKLayer, const f32 *customBlends = NULL);
