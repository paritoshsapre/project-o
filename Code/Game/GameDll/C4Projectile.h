...
public:
	...
	DECLARE_CLIENT_RMI_NOATTACH_FAST(ClSetPosition, ProjectileStaticParams, eNRT_ReliableUnordered);
	DECLARE_CLIENT_RMI_NOATTACH_FAST(ClStickToEntity, ProjectileStickToEntity, eNRT_ReliableUnordered);
