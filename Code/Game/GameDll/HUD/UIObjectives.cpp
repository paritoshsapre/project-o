...
CUIObjectives::CUIObjectives()
{
	...
	if ( pFlashUI )
	{
		...
		m_pUIOEvt = pFlashUI->CreateEventSystem( "UIObjectives", IUIEventSystem::eEST_SYSTEM_TO_UI );
		...
		m_pUIOFct = pFlashUI->CreateEventSystem( "UIObjectives", IUIEventSystem::eEST_UI_TO_SYSTEM );
