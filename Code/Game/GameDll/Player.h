...
public:
	...
	// PLAYERPREDICTION
	static const NetworkAspectType ASPECT_INPUT_CLIENT	= eEA_GameClientD;	
	// ~PLAYERPREDICTION
...
public:
  struct SAlienInterferenceParams
  {
	...
	DECLARE_CLIENT_RMI_NOATTACH_FAST(ClAnimGraphTransition, AnimGraphTransitionParams, eNRT_ReliableOrdered);
	DECLARE_CLIENT_RMI_NOATTACH_FAST(ClAnimGraphInput, AnimGraphInputParams, eNRT_ReliableOrdered);
