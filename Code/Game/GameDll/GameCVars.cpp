...
void SCVars::InitCVars(IConsole *pConsole)
{
	...
	//////////////////////////////////////////////////////////////////////////
	pConsole->Register("cl_cam_newsystem",&cl_cam_newsystem, 0, VF_DUMPTODISK,"New camera control system.");
	pConsole->Register("cl_cam_debug",&cl_cam_debug, 0, VF_DUMPTODISK,"Camera system debug output.");
	...
	pConsole->Register("cl_fake_first_person",&cl_fake_first_person,0,VF_DUMPTODISK,"Enable fake first person view in new new camera control system (cl_cam_newsystem 1).");
