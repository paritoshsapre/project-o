...
class CFlowNode_FeatureTest : public CFlowBaseNode, public IFeatureTest
{
public:
...
class CFlowNode_WatchCodeCheckpoint : public CFlowBaseNode
{
public:
...
class CFlowNode_SimulateInput : public CFlowBaseNode
{
	enum EInputPorts
	{
		eInputPorts_Action,
